                                             ...
                                             uint8_t pretty)
{
  ...
  json_object_dotset_number(JSON_Status, "DeviceInformation.totalStorage", (float_t)temp_f);
  DeviceInformation_get_totalMemory(&temp_f);
  json_object_dotset_number(JSON_Status, "DeviceInformation.totalMemory", (float_t)temp_f);
