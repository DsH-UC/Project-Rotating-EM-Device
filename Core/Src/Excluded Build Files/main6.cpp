...
int main(void)
{
  ...
  /* encoder.init(&htim3); */
  //encoder.start_thread(512, tskIDLE_PRIORITY + 2);
  ...
  //UI_CommandReceiver::get_instance().init(huart); // Choose UART
  //UI_CommandReceiver::get_instance().start_thread(512, tskIDLE_PRIORITY + 1);
