...
CPP_SRCS += \
../Core/Custom/Motor/MotorDriver.cpp 

OBJS += \
./Core/Custom/Motor/MotorDriver.o 

CPP_DEPS += \
./Core/Custom/Motor/MotorDriver.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Custom/Motor/%.o Core/Custom/Motor/%.su Core/Custom/Motor/%.cyclo: ../Core/Custom/Motor/%.cpp Core/Custom/Motor/subdir.mk
...
clean: clean-Core-2f-Custom-2f-Motor

clean-Core-2f-Custom-2f-Motor:
	-$(RM) ./Core/Custom/Motor/MotorDriver.cyclo ./Core/Custom/Motor/MotorDriver.d ./Core/Custom/Motor/MotorDriver.o ./Core/Custom/Motor/MotorDriver.su

.PHONY: clean-Core-2f-Custom-2f-Motor
